...
- 가장 관심 있어 하는 분야는 안드로이드 개발입니다. 그 이유는 많은 사람들이 가지고 활용하는 것이 스마트폰 이고 앱을 통해 많은 서비스가 이용중에 있습니다. 그렇기 때문에 앞으로도 계속해서 앱이라는 플랫폼에서 많은 사용자들이 사용할 것이라 생각합니다. <br>
- 저는 안드로이드 앱 분야에 관심을 가지게 된것은 학부 시절인데 그때부터 우연히 교수의 난초 심부름을 받은 적이 있습니다. 난초란 까다로운 식물이라 출장갈때마다 맏기는것을 보면서 불편함을 느꼈습니다. 그래서 시작하게 된것이 플랜트 시터라는 프로젝트였습니다. 그래서 android를 이용해 식물 케어하는 아두이노 제품과 bluetooth 통신을 하도록 하였습니다. 그래서 bluetooth를 통해 식물의 온도와 습도 상태를 실시간으로 받아보도록 했으며 식물의 정보를 입력하면 거기에 맞는 빛의 상태와 물의 주기에 맞춰 주도록 개발하였습니다. 결국 난초 심부름은 더이상 시키지 않으셨고 더불어 수상까지 하면서 안드로이드 앱의 다양한 확장성과 활용성을 알게되어 관심을 갖게 되었습니다.
<br>
2. 제가 안드로이드 앱 분야에 적합한 이유( 나의 강점)<br>

- 저는 학부시절부터 지금까지 전자입찰, 의료, 모빌러티 분야에서 andorid 구축 및 유지보수를 담당/ 운영한 경험이 있습니다.<br>
- 전자 입찰에서는 10개에 해당하는 앱을 유지보수를 했으며, 메디블록에서 메디패스란 앱에서 코인 워크관련 기능을 추가하면서 10만 앱을 달성한 경험이 있습니다.<br>
- 이러한 다양한 분야에서의 경험을 토대로 새로운 기술에 대해 끊임없이 발전해 나갈 수 있습니다. 마지막으로 다양한 동료와 활발한 커뮤니케이션과 협업을 해야 좋은 결과가 나올 수있다고 생각합니다.<br>
<br>
3. 이직사유?<br>

- 교통사고로인한 후유증으로 휴식이 필요하다고 판단이 되어 퇴사. 현재는 완치되어 이직을 준비중에 있습니다.<br>
<br>
...
** 강원대학교 컴퓨터정보통신공학과 졸업 (2011.03 ~ 2018.08)<br> 
** 중동고등학교 졸업 (2006.03 ~ 2009.02)<br>
...
** 2018 년 산호세 대학 기술 대회 (3등)<br>
** 2017 대한기계학회 우수 발표 논문상 (우수상)<br>
** 2017 아르키메데스 (은상)<br>
